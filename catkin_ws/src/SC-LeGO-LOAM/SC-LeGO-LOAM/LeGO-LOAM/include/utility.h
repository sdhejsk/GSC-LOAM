...
extern const int edgeFeatureNum = 4;
extern const int surfFeatureNum = 6;
...
// Mapping Params
extern const float surroundingKeyframeSearchRadius = 150.0; // key frame that is within n meters from current pose will be considerd for scan-to-map optimization (when loop closure disabled)
extern const int   surroundingKeyframeSearchNum = 150; // submap size (when loop closure enabled)

// history key frames (history submap for loop closure)
extern const float historyKeyframeSearchRadius = 200.0; // NOT used in Scan Context-based loop detector / default 7.0; key frame that is within n meters from current pose will be considerd for loop closure
extern const int   historyKeyframeSearchNum = 250; // 2n+1 number of history key frames will be fused into a submap for loop closure
