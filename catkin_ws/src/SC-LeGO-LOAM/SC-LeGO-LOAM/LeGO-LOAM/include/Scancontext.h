...
public:
    ...
    const int    NUM_CANDIDATES_FROM_TREE = 20; // 10 is enough. (refer the IROS 18 paper)

    // loop thres
    const double SEARCH_RATIO = 0.5; // for fast comparison, no Brute-force, but search 10 % is okay. // not was in the original conf paper, but improved ver.
